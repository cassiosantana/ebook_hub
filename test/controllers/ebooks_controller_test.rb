...
class EbooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ebook" do
    assert_difference("Ebook.count") do
      post ebooks_url, params: { ebook: { author: @ebook.author, description: @ebook.description, genre: @ebook.genre, isbn: @ebook.isbn, price: @ebook.price, title: @ebook.title } }
    end
  ...
  test "should update ebook" do
    patch ebook_url(@ebook), params: { ebook: { author: @ebook.author, description: @ebook.description, genre: @ebook.genre, isbn: @ebook.isbn, price: @ebook.price, title: @ebook.title } }
